...
function Help () {
    ...
    <div id="helpContainer">
        ...
        {window.innerWidth <= 600? (
            <p id="Statement">The top part of the screen contains all currently available trails. You can favorite a trail by clicking on the little heart located under the trail photo. Clicking on a pin on the map will scoll the top part of the page to the trail that you clicked on, and give you information about the trail.</p>
        ):(
        ...
        <br />
        {window.innerWidth <= 600? (
            <p id="Statement">  At any time, you can click on the &quot;All Adventure&quot; logo to return to the home page. To access the map again, simply click on &quot;Explore Nearby Trails&quot; or &quot;New York Favorites&quot; or when logged in click on the profile icon and click on &quot;Map&quot;, you will be taken back to the map. You can also search for a particular trail by name or filter by difficulty using the search bars. </p>
        ):(
            <p id="Statement">  At any time, you can click on the &quot;All Adventure&quot; logo to return to the home page. To access the map again, simply click on &quot;Explore Nearby Trails&quot; or &quot;New York Favorites&quot; or when logged in hover over the profile icon and click on &quot;Map&quot;, you will be taken back to the map. You can also search for a particular trail by name or filter by difficulty using the search bars. </p>
        )}
        
        <br />
        {window.innerWidth <= 600? (
            <p id="Statement">  When logged in, clicking on the profile icon opens a drop down. The drop down contains profile, map, and logout options. If you click &quot;Profile&quot; you will be directed to your profile where you can see your favorites, reviews, and photos. </p>
        ):(
            <p id="Statement">  When logged in, hovering over the profile icon opens a drop down. The drop down contains profile, map, and logout options. If you click &quot;Profile&quot; you will be directed to your profile where you can see your favorites, reviews, and photos. </p>
        )}
        
        <br />
        {window.innerWidth <= 600? (
            <p id="Statement1">  If you wish to leave the site, click on the profile icon where you will find a dropdown menu allowing you to log out.</p>
        ):(
