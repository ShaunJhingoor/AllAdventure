    ...
    sessionLinks = (
      <>
        <div className="innernavlink">
          <h1 id="InfoTab" onClick={() => navigate("/help")}>
            Help
          </h1>
          <button onClick={demoLogin} id="demoLogin" disabled={isLoading}>
            {isLoading ? <div className="navLoader"></div> : "Demo Login"}
          </button>
    ...
    <>
      <nav id="mainNav">
        <div className="links">
          <div id="myLinksNav">
            <NavLink to="/" id="home">
              <img src={adventureIcon} alt="sometrailsicon" id="homeicon" />
              AllAdventure
            </NavLink>
            <a
