    ...
    <>
      <div id="editUserOutside">
        <form onSubmit={handleEditUser} className="editUser">
          ...
          <div>
            ...
            <div id="password">
              ...
              <div onClick={togglePasswordVisibility}>
                {showPassword ? (
                  <img src={hide} alt="hide" id="visibleimg" />
                ) : (
                  <img src={see} alt="see" id="visibleimg" />
                )}
              </div>
            </div>
          </div>
          <div id="passworddisclaimerContainer">
            <p id="passworddisclaimer">
              This field is optional. If left blank, the password will remain
              unchanged.
            </p>
          </div>
          <div>
          ...
          <div id="passworddisclaimerContainer">
            <p id="oldPassworddisclaimer">
              Must enter password to make changes.
            </p>
          </div>
          <div id="buttonsEdit">
