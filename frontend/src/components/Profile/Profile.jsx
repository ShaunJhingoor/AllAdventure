...
import {
  fetchUsersTrailPhotos,
  trailPhotosArray,
} from "../../store/trail_photos";
...
function Profile() {
  ...
  const favoriteTrails = Object.values(favoritesObj)
    ?.filter((favorite) => favorite?.favorite?.user_id == userId)
    ?.map((favorite) => favorite?.favorite?.trail);
    ...
    return (
      <div className="invalidTrail">
        ...
        <p id="invalidTrailStatment">
          This users profile does not exist or has been removed
        </p>
        <br />
        <button
          type="submit"
      ...
      <div id="ProfileFormOutside">
        ...
        <div id="position">
          <form className="profile">
            ...
            <div id="userInfo">
              <p id="Name">
                {capitalizeFirstLetter(profileUser?.fname)}{" "}
                {capitalizeFirstLetter(profileUser?.lname)}
          ...
          {loading || loading1 || loading2 || loading3 ? (
            ...
            <form className="currentReview">
              <div id="currentReviewHeader">
                ...
                <p
                  onClick={() => setSection("F")}
                  className={section === "F" ? "active" : ""}
                  id="currentReviewHeaderFavorite"
                >
                  Favorites
                </p>
                <p
            ...
            <form className="currentReview">
              ...
              <div id="noReviewContentContainer">
                <p id="noReviewContent">
                  Explore other trails and look at other users reviews to find
                  your next adventure.
                </p>
              </div>
              <div id="navigateButtonContainer">
            ...
            <form className="currentReview">
              ...
              <div id="noReviewHeader">
                <p id="noReviewHeaderContent">
                  User Currently has no favorite trails
                </p>
              </div>
              <div id="noReviewContentContainer">
                <p id="noReviewContent">
            ...
            <form className="currentReview">
              ...
              <div id="noReviewContentContainer">
                <p id="noReviewContent">Explore other trails and users</p>
              </div>
              <div id="navigateButtonContainer">
                <button
                  id="navigateButton"
                    ...
                    <div key={`${photo?.id}_${index}`} id="photoContent">
                      <div id="profilePhotoContainer">
                        ...
                        <img
                          ...
                          onClick={() => {
                            window.scrollTo(0, 0);
                            navigate(`/trails/${photo?.trail_id}`);
                          }}
                        />
                      </div>
                      {current?.id == userId && (
